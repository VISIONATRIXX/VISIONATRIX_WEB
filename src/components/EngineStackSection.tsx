    ...
    },
    {
      ...
      tools: [
        ...
        },
        {
          ...
          iconBg: "bg-[#98E704]/10 border-[#98E704]/40 text-[#98E704] shadow-[0_0_15px_rgba(152,231,4,0.25)]"
        },
        {
          id: "sapphire",
  ...
  const renderOfficialLogo = (toolId: string) => {
    switch (toolId) {
      ...
      case "davinci":
        return (
          <img
            src="https://img.icons8.com/color/144/davinci-resolve.png"
            alt="DaVinci Resolve"
            className="w-7 h-7 object-contain drop-shadow-[0_0_8px_rgba(225,29,72,0.4)]"
          />
        );
      case "nuke":
        return (
