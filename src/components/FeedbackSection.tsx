...
export default function FeedbackSection() {
  ...
  return (
    ...
    >
      ...
      <ScrollAnimatedWrapper className="flex flex-col justify-between my-auto z-10 w-full">
        ...
        <div className="w-full border-t border-white/5 py-8 mt-12 overflow-hidden relative bg-black/20">
